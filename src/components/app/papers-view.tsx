...
function MathsPastPaperArchive({ level, topic, onOpenConvo }: { level: string; topic: { id: string; name: string }; onOpenConvo: (handoff: TutorQuestionHandoff) => void }) {
