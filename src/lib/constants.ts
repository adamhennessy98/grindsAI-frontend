...
export const SUBJECTS: Subject[] = [
  ...
  { id: "computer-science", name: "Computer Science", icon: "Book", enabled: true },
...
export const SUBJECT_TOPICS: Record<string, SubjectTopic[]> = {
  ...
  "computer-science": [
    ...
    { id: "algorithms-logic", name: "Algorithms and Logic" },
    { id: "programming", name: "Programming" },
    { id: "computer-systems", name: "Computer Systems" },
    { id: "data-representation", name: "Data Representation" },
    { id: "web-digital-artefacts", name: "Web and Digital Artefacts" },
    { id: "modelling-simulation", name: "Modelling and Simulation" },
    { id: "robotics", name: "Robotics" },
    { id: "computers-society", name: "Computers and Society" },
    { id: "ethics-technology", name: "Ethics and Technology" },
    { id: "applied-learning-tasks", name: "Applied Learning Tasks" },
  ],
  economics: [
...
export const STARTERS: Record<string, string[]> = {
  ...
  "computer-science": ["Help me revise Computer Science", "Explain an algorithm question", "What should I practise first?"],
