...
paper: "Section A B"
question_number: 6
section: "2.   Choose each term from the following list and place it in Column B to match a description in"
...
2.   Choose each term from the following list and place it in Column B to match a description in
    Column A. The first one has been completed as an example.
      ...
      Abiotic    Habitat    Conservation   Biosphere    Ecosystem    Pollution
       ...
       (b)   Area where organisms interact with each other and their
           environment.
