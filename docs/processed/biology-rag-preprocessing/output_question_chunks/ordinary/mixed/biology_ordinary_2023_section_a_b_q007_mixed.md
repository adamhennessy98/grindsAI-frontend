...
paper: "Section A B"
question_number: 7
section: "3.   Choose each term from the following list and place it in Column B to match a description in"
topic: "Mixed"
secondary_topics:
  - "Plant Biology"
  - "Human Biology"
...
has_visual: true
visual_assets:
  - "../../../image_assets/exam_papers/ordinary/biology_ordinary_2023_section_a_b_exam_page_005.png"
  - "../../../image_assets/exam_papers/ordinary/biology_ordinary_2023_section_a_b_exam_page_004.png"
source_exam_pages:
  - "4"
  - "5"
...
3.   Choose each term from the following list and place it in Column B to match a description in
     Column A. The first one has been completed as an example.
       ...
       Hydrochloric
        ...
        (c)   Increase surface area for absorption in
           the small intestine

        (d)   Process by which food waste is passed
          from the body
...
![Page 5](../../../image_assets/exam_papers/ordinary/biology_ordinary_2023_section_a_b_exam_page_005.png)
