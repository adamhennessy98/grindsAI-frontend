...
has_visual: true
visual_assets:
  - "../../../image_assets/exam_papers/ordinary/biology_ordinary_2024_section_c_exam_page_009.png"
source_exam_pages:
  - 9
...
3.   Cochlea
                 (iii)  In your answerbook, match each of the parts of the human ear (ossicle, eardrum
              and cochlea) with the following functions:
              ...
              (iv)  The Eustachian tube is shown in the diagram.
           Why is the middle ear connected to the throat by the Eustachian tube?
             (v)   Hearing is one of the five senses. Name any other two senses.
