...
paper: "Section C"
question_number: 8
section: "3.   The code is translated"
topic: "Unclassified"
secondary_topics: []
...
3.   The code is translated
                 (ii)  What shape is DNA?
                 (iii)   1.   Adenine, thymine, cytosine, guanine and uracil are nitrogenous bases.
                  Which one of the above bases is found in RNA, but not DNA?
                  2.   DNA and RNA have another structural difference. Using the diagrams as an
                         aid, state one other structural difference between DNA and RNA.
              (iv)  DNA profiling and genetic engineering are important biological techniques used
               by biologists.
                  1.    Give any one application (or use) of DNA profiling.
                  2.    Give any one application (or use) of genetic engineering.               (24)
