...
2.   Dermal
                 (ii)  Xylem and phloem are shown in                              B                                           Phloem
                the diagram.
                                                             Air                  1.    Give one function of xylem.
                                                  space
                  2.    Give one function of phloem.
                 (iii)  Which of the following terms
                 describes the evaporation of water                   Stoma
                  into the airspaces of the leaf?
                 Transpiration;   Respiration
              (iv)  When the water evaporates into the airspaces, through which labelled structure
               does it exit the leaf?
             (v)   Veins in leaves can be arranged in a parallel pattern or a net (reticulate) pattern.
