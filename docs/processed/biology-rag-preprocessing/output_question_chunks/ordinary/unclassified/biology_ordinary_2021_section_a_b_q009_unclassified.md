...
paper: "Section A B"
question_number: 9
section: "3.   Choose each structure from the following list and place it in Column B to match a location in"
topic: "Unclassified"
secondary_topics: []
...
has_visual: true
visual_assets:
  - "../../../image_assets/exam_papers/ordinary/biology_ordinary_2021_section_a_b_exam_page_004.png"
source_exam_pages:
  - 4
...
3.   Choose each structure from the following list and place it in Column B to match a location in
